...
<style>
    ...
    /* ── Sidebar Page Navigation (auto-generated by Streamlit) ──
       This menu (AI Coach / Today's Schedule / Analytics / ...) has
       its own default text color that ignores the app's theme toggle
       entirely unless explicitly overridden here. */
    ...
    /* ── Force text color on native Streamlit elements (main area) ──
       Without this, widget labels, captions, and plain markdown text
       outside the sidebar keep Streamlit's own default text color
       instead of following the app's dark/light toggle - invisible
       (near-white on white) when switched to light mode. */
